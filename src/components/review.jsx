...
const Review = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-100 px-4 sm:px-6 lg:px-8">
      <h1 className="text-xl sm:text-2xl font-bold text-center">Review Your Answers</h1>
      
      <div className="bg-white shadow-lg rounded-lg p-6 sm:p-8 w-full max-w-lg sm:max-w-2xl lg:max-w-4xl mt-5">
        {questions.map((question) => (
          <div key={question.id} className="mb-4">
            <h2 className="font-semibold text-lg sm:text-xl">{question.question}</h2>
        ...
        <button
          className="w-full sm:w-auto mt-6 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition-all duration-300"
          onClick={() => navigate('/quiz')}
        >
          Go Back to Quiz
        </button>

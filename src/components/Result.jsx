...
const Result = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-100 px-4 sm:px-6 lg:px-8">
      {/* Result Container */}
      <div className="bg-white shadow-lg rounded-lg p-6 sm:p-10 w-full max-w-md sm:max-w-lg lg:max-w-3xl text-center mt-5 sm:mt-7">
        {/* Celebration Icon */}
        <div className="text-4xl sm:text-6xl mb-4">🎉</div>

        {/* Congratulation Message */}
        <h1 className="text-2xl sm:text-4xl font-bold text-black mb-4">Congratulations!</h1>
        <p className="text-lg sm:text-xl text-gray-700 mb-6">You have completed the quiz.</p>

        {/* Score Display */}
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6 mb-6 shadow-sm">
          <p className="text-xl sm:text-2xl font-bold text-[#5072A7]">
            Your Score: <span className="text-black">{score}</span> / {totalQuestions}
          </p>
          <p className="mt-2">You got {correctAnswersCount} out of {questions.length} correct!</p>
        </div>
        ...
        {/* Button Container */}
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mt-4 items-center justify-center">
          {/* Review Button */}
          <button
            onClick={handleReviewAnswers}
            className="w-full sm:w-auto bg-blue-400 text-white py-2 px-4 sm:py-3 sm:px-6 rounded hover:bg-blue-500 transition-all duration-300"
          >
            Review Answers
          </button>
          ...
          <button
            onClick={handleBackToHome}
            className="w-full sm:w-auto bg-blue-500 text-white py-2 px-4 sm:py-3 sm:px-6 rounded hover:bg-blue-600 transition-all duration-300"
          >
            OK, Take me Home
          </button>
        </div>

    ...
    >
      ...
      <nav className="w-full bg-[#004687] shadow-md fixed top-0 left-0 right-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-4">
          ...
          {/* Navigation Links */}
          <div className="space-x-8 sm:space-x-10 md:space-x-20">
            <Link to="/signup" className="text-white hover:underline text-lg sm:text-xl font-medium">
              Signup
            </Link>
            <Link to="/login" className="text-white hover:underline text-lg sm:text-xl font-medium">
              Login
            </Link>
          </div>
        </div>
      ...
      {/* Main content */}
      <div className="flex flex-col justify-center items-center text-center mt-32 sm:mt-40 md:mt-48 space-y-4">
        {/* Big Heading */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-[#002D62]">
          Ready to start a quiz?
        </h1>
        {/* Subheading */}
        <p className="text-base sm:text-lg md:text-xl font-bold text-black">
          "Believe in your potential and tackle each question with confidence."
        </p>

        {/* Button to Sign Up */}
        <Link to="/signup">
          <button className="mt-6 px-6 sm:px-8 py-2 sm:py-3 bg-[#002D62] text-white rounded-lg text-base sm:text-lg font-semibold shadow-md hover:bg-blue-600 transition">
            Get Started
          </button>
        </Link>
      </div>
